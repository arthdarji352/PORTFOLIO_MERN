        ...
        <div className="row">
          ...
          <div className="col-md-6 col-xl-6 col-lg-6 col-xs-12 about-content">
            ...
            <p className="fst-italic">
              ...
              interfaces utilising contemporary Javascript frameworks like React
              and NextJS. I also have experience with server-side technologies
              like Node.js, Express.js, and MongoDB, which enables me to create
              scalable backend systems and robust APIs.
              <br />
